...
describe('Refactored token middleware', () => {
  beforeEach(async () => {
    ...
    const user = new User({ username: 'root', name: 'root first', passwordHash })
  ...
  test('Adding blog with invalid token', async () => {
    ...
    const invalidToken = "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InNhbmNoZXo3IiwiaWQiOiI2Mjg0MTA0YjE3NjhmNzk2ZDg1MzY1MWIiLCJpYXQiOjE2NTI4MjIxMTh9.4VIzH1j9Va-pLGZrm8FQpNjZVvq3IfxNgIw4tVIBguB"
